...
function GB_CreateGUI()
   ...
   --audit history view
   GB_ColumnHeaderAuditTimeMiddle:SetWidth(24-9)
   GB_ColumnHeaderAuditTypeMiddle:SetWidth(24-9)
   GB_ColumnHeaderAuditItemMiddle:SetWidth(24-9)
   GB_ColumnHeaderAuditNameMiddle:SetWidth(150-9)
   GB_ColumnHeaderAuditAmountMiddle:SetWidth(161-9)
...
function GB_DisplayAuditHistory()
    ...
    GB_ConfigScrollFrame:Hide() 
    --set portrait icon
    SetPortraitToTexture(GB_ListFrameSkullnXBonesTexture,"interface\\icons\\inv_misc_book_09")
    --GB_HitListFrameSkullnXBones:SetFrameStrata("BACKGROUND")   
end
